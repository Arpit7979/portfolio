    ...
    <div className="flex flex-col items-center bg-gradient-to-b from-slate-900 to-indigo-200 text-white overflow-hidden relative">
      ...
      <div className="flex w-full justify-between items-center">
        <div className="bg-slate-900 text-white p-5 rounded-2xl max-w-80 -rotate-10 shadow-xl/100 inset-shadow-sm inset-shadow-indigo-200">
          <h2 className="font-bold text-xl">Client Review</h2>
          <p className="text-sm text-[#9E9FA5]">
            Outstanding Web Developer, Highly recommended without Hesitation
          </p>
        </div>
        <img className="w-100" src={assets.arpit} alt="" />
        <div className="bg-slate-900 text-white p-5 rounded-2xl max-w-80 rotate-10 shadow-xl/100 inset-shadow-sm inset-shadow-indigo-200">
          <h2 className="font-bold text-xl">MY EXPERTISE</h2>
          <div className="flex gap-2 items-center py-2">
            <h4 className="text-sm text-[#9E9FA5]">FRONTEND</h4>
            <div className="h-1 w-100 bg-white rounded-lg flex items-center relative">
          ...
          <div className="flex gap-2 items-center">
            <h4 className="text-sm text-[#9E9FA5]">BACKEND</h4>
            <div className="h-1 w-100 bg-white rounded-lg flex items-center relative">
      ...
      <button className="absolute bottom-4 bg-[#ffde59] p-3 rounded-full cursor-pointer border-1 border-black text-black font-bold">
        MY PROJECTS
      </button>
    </div>
  );
